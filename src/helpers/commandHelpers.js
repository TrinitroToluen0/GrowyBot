...
- </bumpreminder-setthankschannel:1231154695716868128> Set a channel for the bump reminder module to publicly thank all of the bumpers in your server.
...
- Reminder channel ➞ ${guildConfig.bumpReminderChannel ? `<#${guildConfig.bumpReminderChannel}>` : "None"}
- Thanks channel ➞ ${guildConfig.bumpThanksChannel ? `<#${guildConfig.bumpThanksChannel}>` : "None"}
